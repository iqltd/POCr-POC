...
public class WebAppType {
	 ...
	 * <CODE>set</CODE> method for the moduleNameOrDescriptionAndDisplayName
	 * property.
	 *
	 * <p>
	 ...
	 * {@code <}{@link SecurityRoleType }{@code >} {@link JAXBElement }{@code <}
	 * {@link EjbLocalRefType }{@code >} {@link JAXBElement }{@code <}
	 * {@link MailSessionType }{@code >} {@link JAXBElement }{@code <}
	 * {@link MessageDestinationRefType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ServiceRefType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ListenerType }{@code >} {@link JAXBElement }{@code <}
	 * {@link PersistenceUnitRefType }{@code >} {@link JAXBElement }{@code <}
	 * {@link DescriptionType }{@code >} {@link JAXBElement }{@code <}
	 * {@link AbsoluteOrderingType }{@code >} {@link JAXBElement }{@code <}
	 * {@link org.jcp.xmlns.xml.ns.javaee.String }{@code >} {@link JAXBElement }
	 * {@code <}{@link MessageDestinationType }{@code >} {@link JAXBElement }
	 * {@code <}{@link LifecycleCallbackType }{@code >} {@link JAXBElement }
	 * {@code <}{@link EmptyType }{@code >} {@link JAXBElement }{@code <}
	 * {@link MimeMappingType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ResourceRefType }{@code >} {@link JAXBElement }{@code <}
	 * {@link SessionConfigType }{@code >} {@link JAXBElement }{@code <}
	 * {@link LoginConfigType }{@code >} {@link JAXBElement }{@code <}
	 * {@link LocaleEncodingMappingListType }{@code >} {@link JAXBElement }
	 * {@code <}{@link ServletType }{@code >} {@link JAXBElement }{@code <}
	 * {@link LifecycleCallbackType }{@code >} {@link JAXBElement }{@code <}
	 * {@link AdministeredObjectType }{@code >} {@link JAXBElement }{@code <}
	 * {@link EnvEntryType }{@code >} {@link JAXBElement }{@code <}
	 * {@link WelcomeFileListType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ErrorPageType }{@code >} {@link JAXBElement }{@code <}
	 * {@link SecurityConstraintType }{@code >} {@link JAXBElement }{@code <}
	 * {@link EmptyType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ParamValueType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ResourceEnvRefType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ConnectionFactoryResourceType }{@code >} {@link JAXBElement }
	 * {@code <}{@link JmsDestinationType }{@code >} {@link JAXBElement }{@code <}
	 * {@link ServletMappingType }{@code >} {@link JAXBElement }{@code <}
	 * {@link PersistenceContextRefType }{@code >} {@link JAXBElement }{@code <}
	 * {@link DisplayNameType }{@code >} {@link JAXBElement }{@code <}
	 * {@link DataSourceType }{@code >} {@link JAXBElement }{@code <}
	 * {@link FilterType }{@code >} {@link JAXBElement }{@code <}
	 * {@link JspConfigType }{@code >} {@link JAXBElement }{@code <}
	 * {@link JmsConnectionFactoryType }{@code >} {@link JAXBElement }{@code <}
	 * {@link FilterMappingType }{@code >}
	 *
	 *
	 */
	public List<JAXBElement<?>> getModuleNameOrDescriptionAndDisplayName() {
		...
		return moduleNameOrDescriptionAndDisplayName;
	}
